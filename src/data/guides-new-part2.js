export const guidesNewPart2 = [
  {
    id: 14,
    slug: 'dlc-meta-builds-2026',
    title: 'Elden Ring DLC Meta Builds 2026: Beast Claws, Perfume Bottles & More',
    excerpt:
      'The Shadow of the Erdtree DLC has shaken up the meta. After the latest 2025-2026 patches, these are the strongest, most fun DLC builds — complete with stats, gear lists, and expert reasoning for why each build dominates.',
    category: 'Builds',
    date: '2026-07-27',
...
`
...

  {
    ...
    title: 'Best Rune Farming Spots in Elden Ring: Level Up Fast (2026 Guide)',
    excerpt:
      'Leveling up in Elden Ring shouldn\'t feel like a grind. This 2026 guide covers every major rune farm from early game to the 10M+ runes/hour Mohgwyn Palace method — plus DLC farming spots and multiplier-stacking tips.',
