export const guidesPart1 = [
  {
    id: 1,
    slug: "beginner-guide",
    title: "Elden Ring Beginner Guide: Everything You Need to Know",
    excerpt: "New to the Lands Between? This comprehensive Elden Ring beginner guide covers everything from your first steps to essential survival tips that will save you hours of frustration.",
    category: "Beginner",
    date: "2026-07-27",
...
`
...

  {
    ...
    title: "Best Starting Class in Elden Ring: Complete Breakdown",
    excerpt: "Wondering which Elden Ring starter class is right for you? We break down every starting class with detailed stats, early-game viability, and which playstyle each one suits best.",
    category: "Beginner",
    date: "2026-07-27",
    updatedDate: "2026-07-27",
    readTime: 10,
...
`
...

  {
    ...
    title: "Elden Ring Boss Order Guide: When to Fight Each Boss",
    excerpt: "Lost in the Lands Between? This Elden Ring boss order guide tells you exactly when to fight each boss, which ones to skip, and what level you should be at for every major encounter.",
    category: "Bosses",
    date: "2026-07-27",
    updatedDate: "2026-07-27",
    readTime: 15,
...
`
...

  {
    ...
    title: "Best Elden Ring Builds: Top Meta & Fun Builds for 2024",
    excerpt: "Looking for the best Elden Ring build? From meta PvP builds to creative PvE setups, we cover the top builds that dominate in 2024 with stat allocations, gear, and strategies.",
    category: "Builds",
    date: "2026-07-27",
    updatedDate: "2026-07-27",
    readTime: 14,
...
`
...

  {
    id: 5,
    slug: "hidden-secrets",
    title: "Elden Ring Hidden Secrets You Probably Missed",
    excerpt: "Think you have seen everything in the Lands Between? These Elden Ring secrets and hidden bosses will surprise even veteran players. Discover tricks, hidden areas, and lore you missed.",
